...
const BestSellerForDogsProducts: Product[] = [
   {
      id: 1,
...
function BestSellerForDogs() {
   return (
      <div className="py-6 sm:py-8 mx-auto">
         <CardComponents
            products={BestSellerForDogsProducts}
            title="Best Seller for Dogs"
         />
      </div>
   );
}

export default BestSellerForDogs;
